            ...
            return(
                <>
                    ...
                    ${childrenNum <= 2
                        ...
                        : "grid-cols-[repeat(auto-fit,minmax(250px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(280px,1fr))]"
                    }
                    gap-4 overflow-hidden transition-[max-height] duration-200 pt-1 px-1 mb-2 sm:mt-2 sm:mb-4 ${active ? "max-h-100" : "max-h-0"}`}>
