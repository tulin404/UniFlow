export default function Header({ theme, setTheme }) {
    ...
    return (
        <header className="bg-header py-6 flex justify-center relative transition-colors duration-200">
            ...
            <div id="change-theme-wrapper" className="absolute h-11 w-11 right-5  translate-y-1/2 bottom-1/2">
                <button className="absolute size-full">
                    <img
                        ...
                        src="/sun.svg"
                        alt="Light mode icon"
                        className={`inset-0 absolute hover:cursor-pointer hover:rotate-90 hover:scale-105 hover:-translate-y-1 transition-all duration-500 ${theme === 'dark' ? 'rotate-90 opacity-0 pointer-events-none -z-10' : 'rotate-0 opacity-100 pointer-events-auto z-10'}`} 
                ...
                <button className="absolute size-full">
                    <img
                        ...
                        src="/moon.svg"
                        alt="Dark mode icon"
                        className={`scale-90 inset-0 hover:scale-[95%] hover:cursor-pointer hover:-translate-y-1 absolute transition-all duration-500 ${theme === 'dark' ? '-rotate-35 opacity-100 pointer-events-auto z-10' : 'rotate-90 opacity-0 pointer-events-none -z-10'}`}
